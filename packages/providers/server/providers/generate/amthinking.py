"""
Provider para geração de texto com AM-Thinking-v1 (LLM).
"""
...
class AMThinkingProvider:
    """
    Provider para geração de texto usando AM-Thinking-v1.
    """
    def __init__(self, model_name: Optional[str] = None):
        self.model_name = model_name or DEFAULT_MODELS["am-thinking-v1"]
        self.tokenizer = None
        self.model = None
    ...
    def load_model(self) -> bool:
        ...
        try:
            ...
            print(f"🔄 Carregando modelo AM-Thinking-v1: {self.model_name}")
            ...
            print(f"✅ Modelo AM-Thinking-v1 carregado em {load_time:.2f}s")
            return True
        except Exception as e:
            print(f"❌ Erro ao carregar modelo AM-Thinking-v1: {str(e)}")
            return False
    ...
    def unload_model(self) -> None:
        if self._is_loaded:
            ...
            print(f"🗑️  Modelo AM-Thinking-v1 descarregado da memória")
