...
class TestCPUOnlyEnforcement:
    ...
    def test_environment_variables_cpu(self):
        ...
        ), "TORCH_NUM_THREADS deve igualar CPU_THREADS"
...
class TestProviderIsolation:
    ...
    def test_isolated_constants(self):
        ...
        from server.constants import DEFAULT_MODELS, DEVICE, SERVER_PORT
...
class TestNoCudaAccess:
    ...
    def test_cuda_functions_not_called(
        self, mock_set_device, mock_device_count, mock_is_available
    ):
        ...
        if mock_set_device.called:
            ...
            for call in call_args:
                ...
                if args:
                    assert (
                        args[0] == -1
                    ), f"torch.cuda.set_device() chamado com {args[0]}, esperado -1"
    ...
    def test_device_placement_cpu(self):
        ...
        for tensor in test_tensors:
            ...
            ), f"Tensor deve estar em CPU, mas está em {tensor.device}"
