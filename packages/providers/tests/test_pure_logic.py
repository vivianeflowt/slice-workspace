...
class TestClassificationLogic:
    ...
    def test_model_info_structure(self):
        ...
        for field in required_fields:
            assert field in info, f"Campo obrigatório '{field}' não encontrado em model_info"
...
class TestPosTagLogic:
    ...
    def test_pos_tag_mapping(self):
        ...
        for english_tag, portuguese_tag in expected_mappings.items():
            assert english_tag in mapping, f"Tag '{english_tag}' não encontrada no mapeamento"
    ...
    def test_pos_tag_provider_info(self):
        ...
        required_fields = ["name", "type", "loaded", "device", "supported_tags", "language"]
        for field in required_fields:
