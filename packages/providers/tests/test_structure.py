...
class TestProjectStructure:
    ...
    def test_root_files_exist(self):
        ...
        for file_name in required_files:
            ...
            assert file_path.exists(), f"Arquivo obrigatório não encontrado: {file_name}"
    ...
    def test_server_structure_exists(self):
        ...
        for dir_name in required_dirs:
            ...
            assert dir_path.exists(), f"Diretório obrigatório não encontrado: {dir_name}"
    ...
    def test_init_files_exist(self):
        ...
        for init_file in required_init_files:
            ...
            assert init_path.exists(), f"Arquivo __init__.py não encontrado: {init_file}"
    ...
    def test_functional_organization(self):
        ...
        for function in required_functions:
            ...
            assert function_dir.exists(), f"Diretório de função não encontrado: {function}"
